###  Call syntax:
###
###       Encrypt.py  PLAINTEXT.txt  CIPHERTEXT.txt
###
###  The encrypted output is deposited in the file 'CIPHERTEXT.txt'
...
if len(sys.argv) > 1:
    ...
    for ch in message:
        ...
        while(len(a) != 8):
            a = '0' + a
        fout.write('{}\n'.format(''.join(encrypt(a))))

    fin.close()
    fout.close()

    print('Round key 1 : {}'.format(''.join(key1)))
    print('Round key 1 : {}'.format(''.join(key2)))